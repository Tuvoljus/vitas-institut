...
const Triggerpunktbehandlung = () => {
  return (
    <>
      <Head>
        <title>Physiopraxis - Triggerpunktbehandlung</title>
      </Head>
      <HeaderPicture text="Triggerpunktbehandlung" />
      <section>
        <Container>
          <Row>
            {/* Sitemenue */}
            ...
            <Col md={7}>
              <div className={inhaltBehandlung}>
                ...
                <br />
                <p>
                  Neben den Sehnenansätzen ({'>'} Liebscher %26 Bracht), kann
                  man über die Behandlung der Triggerpunkte in den Faszien und
                  der Muskulatur gute Erfolge bei der Schmerzlinderung erzielen.
                </p>
                <p>
                  Triggerpunkte sind knötchen- bis strangförmige Verhärtungen in
                  der Muskulatur und den Faszien.
                </p>
